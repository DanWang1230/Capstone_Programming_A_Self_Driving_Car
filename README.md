...
* how to update the waypoints and to publish the base waypoints to the set of final waypoints in front of the car
* how to control the car to follow these waypoints
...
I created [here](https://github.com/DanWang1230/creating_dataset_TFRecord) a repo for generating my own dataset that is ready for the following model traing step.

#### 2. Model training

I created [here](https://github.com/DanWang1230/model_training_object_deteciton_API) another repo for fine training the model. Basically, I used the [TensorFlow Object Detection API](https://github.com/tensorflow/models/tree/master/research/object_detection) as a start point for building my own classifier. Two models for the simulation and real testing are trained and uploaded to `tl_detector/light_classification`.

#### 3. Integrating the traffic light classifier to the architecture
`tl_detector.py` and `tl_classifier.py` are updated to classify correctly the traffic light.
